...
public class FetchAddressIntentService extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        if (location == null) {
            ...
            deliverResultToReceiver(AppConstants.FAILURE_RESULT, errorMessage, null,null, null, null);
            return;
        }
        ...
        if (addresses == null || addresses.size()  == 0) {
            ...
            // getLocality() ("Jassowal", for example)
            // getAdminArea() ("Punjab", for example)
            // getPostalCode() ("147004", for example)
            // getCountryCode() ("IN", for example)
            // getCountryName() ("India", for example)
            deliverResultToReceiver(AppConstants.SUCCESS_RESULT, getString(R.string.address_found) ,address.getLatitude() ,
                    address.getLongitude() , address.getSubLocality() , address.getSubAdminArea());
        }
    }
